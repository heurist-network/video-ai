...
review a new proof. Source changes, including the runner, invalidate earlier approval.
...
```sh
npm run final -- --browser /absolute/path/to/chrome --receipt checks/<proof-run>/receipt.json --approval approval.json
```
