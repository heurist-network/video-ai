...
Retrieve ideas and 2–4 frames for a shortlist, then review notes before proposing. Images validate composition; a few stills do not establish precise motion paths or easing. Distinguish Gemini observations, verified evidence, and your proposed adaptation. Existing audio comments are historical; skip them. Do not equate price change, predicted direction, market probability, and resolved outcomes.
